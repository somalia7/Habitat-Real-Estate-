...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/HOMEPG2.jpg'); background-size: 100%; background-position: center center; background-repeat: no-repeat;">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Efficient Solutions for Selling Your Home Quickly and Hassle-Free.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Efficient Rental Solutions for Your Property Needs.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Comprehensive Property Listings for Your Ideal Home.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Navigating Legalities for Sound Real Estate Investments.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--	Why Choose Us -->
        <div class="full-row living bg-one overlay-secondary-half" style="background-image: url('images/02.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Experience excellence in real estate services with our top-rated team. Trust us to exceed your expectations and deliver exceptional results.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Choosing us means choosing excellence. Our commitment to quality is unwavering, ensuring every step of your real estate journey is met with precision, professionalism, and personalized service..</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our team of seasoned professionals brings years of expertise to every transaction, ensuring a smooth and successful experience for our clients.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>This could encompass various topics related to real estate management, such as property investment strategies, market trends, property maintenance and improvement, tenant management, legal and regulatory compliance, and financial planning. It could also involve discussing specific challenges or goals related to managing real estate assets.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>This typically involves examining documents related to real estate transactions, property management, leasing agreements, financial records, and legal documents. Reviewing these files allows you to assess the current status and history of a property or portfolio, identify any potential issues or opportunities, and make informed decisions.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                        <div class="bg-success text-white rounded-circle position-absolute z-index-9" style="color: black;">3</div>
                            ...
                            <p>Acquiring real estate involves purchasing properties either for investment purposes or for use in your business operations. This process typically involves market research, financial analysis, negotiation with sellers, due diligence (including reviewing files as mentioned earlier), securing financing, and completing the transaction.</p>
                        </div>
                    </div>
                </div>
            </div>
