...
<div id="page-wrapper">
    <div class="row"> 
		...
		<!--  -->
        <!--	Contact Information -->
        <div class="full-row" style="background-color: black;">
            <div class="container">
                <div class="row">
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">777 Irony Lane, Parody Park, Ptown, LMFAO 24680</span> <br>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="d-table text-white">High_Class_Habitat_Handlers@realestate.com</span>
